...
> Mục này đáp ứng yêu cầu ở §4 của đề bài: *"declare any AI-tool use in README.md"*.
> Đề cho phép dùng AI như một công cụ; điều bị phạt là **không khai báo**, chứ không
> phải việc sử dụng. Nhóm khai đầy đủ và cụ thể ở dưới.

### Thang mức độ sử dụng

| Mức | Nghĩa |
|---|---|
| 0 | Không dùng AI |
| 1 | Hỏi khái niệm, tra cứu API, giải thích lỗi — không lấy dòng code nào |
| 2 | Người viết code, AI rà soát và góp ý |
| 3 | AI sinh bản nháp, người viết lại theo cách hiểu của mình rồi kiểm chứng |
| 4 | AI sinh phần lớn nội dung, người đọc hiểu, sửa cho khớp instance của nhóm, và kiểm chứng bằng phép kiểm chạy được |
